...
<div class="bg-white rounded-2xl shadow-soft-lg hover:shadow-soft-xl transition-all duration-300"
    ...
    <!-- Card Header Gradient (Green for completed) -->
    ...
    <div class="p-6">
        ...
        <div class="flex items-start justify-between mb-4">
            ...
            <span class="px-3 py-1 rounded-full text-xs font-bold whitespace-nowrap ml-2 bg-green-100 text-green-700">
                {{ $tugas['kesulitan'] }}
            </span>
        </div>
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-xs font-bold text-green-600">{{ $tugas['persentase'] }}%</span>
            </div>
            <div class="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
                <div class="bg-gradient-to-r from-green-400 to-green-600 h-2 rounded-full w-full"></div>
            </div>
        </div>
        ...
        <div class="flex gap-3 items-center">
            ...
            <form action="{{ route('tugas.update', $tugas['id']) }}" method="POST" class="flex-1">
                @csrf
                @method('PUT')
                <input type="hidden" name="persentase" value="0">
                <button type="submit"
                        class="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white px-3 py-2 rounded-lg font-semibold transition-all duration-200 shadow-sm hover:shadow-md text-xs">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="relative z-40 flex-shrink-0">
                ...
                <div class="menu-dropdown hidden absolute right-0 -top-40 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
